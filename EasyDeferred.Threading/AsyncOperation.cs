...
namespace EasyDeferred.Threading
{
    ...
    /// </summary>
    public class AsyncOperationAlreadyRunException : System.ApplicationException
    {
        /// <summary>
        /// 
        /// </summary>
        public AsyncOperationAlreadyRunException()
    ...
    public abstract class AsyncOperation
    {
        ...
        public void Start() {
            lock (this) {
                if (isRunning) {
                    throw new AsyncOperationAlreadyRunException();
                }
    ...
    class testAsyncOperation {
        class AsyncOP : AsyncOperation
        {
            public string Name {
                get;private set;
            }
            public AsyncOP(string name,ISynchronizeInvoke syncInvoke) 
                : base(syncInvoke) {
                this.Name = name;
            }
        ...
        public void test() {
            AsyncOP ap = new AsyncOP("ap1", new SyncContextInvoke());
            ap.Start();
