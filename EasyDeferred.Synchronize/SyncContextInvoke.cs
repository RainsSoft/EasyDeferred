...
using EasyDeferred.Collections.Generic;
namespace EasyDeferred.Synchronize
{
    ...
    /// </summary>
    public partial class SyncContextInvoke : SynchronizationContext, IComponent, ISynchronizeInvoke
    {
        ...
        /// </param>
        public SyncContextInvoke(IContainer container) {
